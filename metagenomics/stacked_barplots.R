...
# === Set sample order ===
# Edit this vector to reorder bars left → right; NULL keeps original CSV order
sample_order <- NULL  # e.g. c("SampleC", "SampleA", "SampleB")

if (!is.null(sample_order)) {
  df_long$Name <- factor(df_long$Name, levels = sample_order)
} else {
