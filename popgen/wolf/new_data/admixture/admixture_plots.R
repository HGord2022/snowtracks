setwd("~/github_repos/snowtracks/popgen/wolf/new_data/admixture")
...
pop_order <- c(
  "Yakutia","Mongolia","Altai","China","Tibet","India","Azerbaijan","Georgia",
  "Iran","Israel","Bulgaria","Greece","Croatia","Slovakia","Ukraine","Poland",
  "Russia","Latvia","Belarus","Finland","Scandinavia","Europe","Spain","Iberia",
  "Portugal","Italy","France","Slovenia"
)
...
plot_admixture <- function(K) {
  ...
  # --- Load Q file ---
  Q <- read.table(paste0("wolf_final.", K, ".Q"), header = FALSE)
  ...
  # --- Save plot ---
  ggsave(
    filename = paste0("wolf_plot_K", K, ".png"),
    plot = p,
